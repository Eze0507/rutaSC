...
from .views import LineasViewSet, RutaLineaViewSet, ListaLineaViewSet, RutaOptimaViewSet, SugerenciasGoogleView
...
urlpatterns = [
    ...
    path('sugerencias-google/', SugerenciasGoogleView.as_view(), name='sugerenciasgoogle'),
]